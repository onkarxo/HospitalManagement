...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #2e05b3, #f9fad3);background: linear-gradient(to bottom, #2e05b3, #f9fad3); background-size: cover;">
